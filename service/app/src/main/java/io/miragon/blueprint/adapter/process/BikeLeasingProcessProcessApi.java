...
public final class BikeLeasingProcessProcessApi {
  ...
  public static final class Messages {
    ...
    public static final MessageName MIRAVELO_LEASING_ACTIVATED = new MessageName("miravelo.leasingActivated");
  ...
  public static final class ServiceTasks {
    public static final String ACTIVATE_LEASING_DELEGATE = "#{activateLeasingDelegate}";

    public static final String CANCEL_CONTRACT_DELEGATE = "#{cancelContractDelegate}";

    public static final String CANCEL_POLICY_DELEGATE = "#{cancelPolicyDelegate}";

    public static final String ISSUE_INSURANCE_POLICY_DELEGATE = "#{issueInsurancePolicyDelegate}";

    public static final String ORDER_BIKE_DELEGATE = "#{orderBikeDelegate}";

    public static final String SEND_CANCELLATION_CONFIRMATION_DELEGATE = "#{sendCancellationConfirmationDelegate}";

    public static final String SEND_CONTRACT_DELEGATE = "#{sendContractDelegate}";

    public static final String SEND_REJECTION_DELEGATE = "#{sendRejectionDelegate}";
  ...
  public static final class Flows {
    ...
    public static final BpmnFlow FLOW_WITHDRAWAL_ELAPSED_TO_ACTIVE = new BpmnFlow("flow_withdrawalElapsedToActive", null, "event_withdrawalPeriodElapsed", "endEvent_leasingActive", null, false);
  ...
  public static final class Relations {
    ...
    public static final BpmnRelations END_EVENT_LEASING_ACTIVE = new BpmnRelations("Leasing active", List.of("event_withdrawalPeriodElapsed"), List.of(), null, null, List.of(), "MESSAGE_END_EVENT");
    ...
    public static final BpmnRelations EVENT_WITHDRAWAL_PERIOD_ELAPSED = new BpmnRelations("Await end of withdrawal period", List.of("event_handoverReported"), List.of("endEvent_leasingActive"), null, null, List.of(), "TIMER_INTERMEDIATE_CATCH_EVENT");
