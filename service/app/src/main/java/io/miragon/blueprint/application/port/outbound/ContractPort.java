 ...
 * of the SAGA compensation. (Notifying the customer to sign is a separate {@link NotificationPort}
 * concern.) A real integration replaces the logging adapter without touching the application layer.
 */
