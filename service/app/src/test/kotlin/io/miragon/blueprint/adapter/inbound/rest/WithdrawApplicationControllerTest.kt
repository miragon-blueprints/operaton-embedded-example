...
class WithdrawApplicationControllerTest {
    ...
    @MockkBean
    private lateinit var useCase: WithdrawApplicationUseCase

    @Test
    fun `customer withdraws the application`() {

        // given: a valid application-id path variable & rest-operation
        val pathVar = "123e4567-e89b-12d3-a456-426614174000"
        every { useCase.withdraw(any()) } just Runs
        val operation = post("/api/bike-leasing/{applicationId}/withdraw", pathVar)
